...
cp $DIR/configs_mainnet/eigen_operator_config.yaml "$user_path/sidecar/"
cp $DIR/configs_mainnet/config.yaml "$user_path/sidecar/"
...
cp -r $DIR/configs_mainnet/app.toml $user_path/config/
cp -r $DIR/configs_mainnet/client.toml $user_path/config/
cp -r $DIR/configs_mainnet/config.toml $user_path/config/
mv $user_path/cosmovisor/config/data $user_path
curl -s https://rpc.diamond.zenrocklabs.io/genesis | jq .result.genesis > $user_path/config/genesis.json
